...
execute as @e[tag=this,tag=1] align xyz run function portal:orange/portal_down/north

execute as @e[tag=this,tag=2] align xyz positioned ~ ~ ~1 run function portal:orange/portal_down/north

execute as @e[tag=this,tag=3] align yz run function portal:orange/portal_down/north

execute as @e[tag=this,tag=4] align yz positioned ~ ~ ~1 run function portal:orange/portal_down/north

execute as @e[tag=this,tag=5] align xz run function portal:orange/portal_down/north

execute as @e[tag=this,tag=7] align y run function portal:orange/portal_down/north
