...
scoreboard players set #maxframe n 31
...
data modify entity @s[tag=empty] item.components."minecraft:custom_model_data" set value 57
data modify entity @s[tag=clean] item.components."minecraft:custom_model_data" set value 59
data modify entity @s[tag=rusted] item.components."minecraft:custom_model_data" set value 61
