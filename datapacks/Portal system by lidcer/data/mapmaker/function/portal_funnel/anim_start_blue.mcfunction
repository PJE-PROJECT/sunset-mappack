...
execute if entity @s[tag=active] run scoreboard players remove #frame n 16
...
data modify entity @s[tag=clean] item.components."minecraft:custom_model_data" set value 102
data modify entity @s[tag=rusted] item.components."minecraft:custom_model_data" set value 105
