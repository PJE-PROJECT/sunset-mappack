...
execute positioned as @a[tag=test_subject,limit=1] as @e[type=minecraft:item_display,tag=laser_field,distance=..1] positioned as @s run function mapmaker:portal_laser_field/check