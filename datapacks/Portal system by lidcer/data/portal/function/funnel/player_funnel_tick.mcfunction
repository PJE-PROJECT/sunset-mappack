...
execute if entity @e[type=minecraft:item_display,distance=..1.9,tag=funnel_h,limit=1,tag=!E,tag=!W] unless entity @e[type=minecraft:item_display,distance=..1.9,tag=funnel_h,limit=1,tag=!S,tag=!N] unless entity @e[type=minecraft:item_display,distance=..1.9,tag=funnel_y,limit=1] run function portal:funnel/slide/x
