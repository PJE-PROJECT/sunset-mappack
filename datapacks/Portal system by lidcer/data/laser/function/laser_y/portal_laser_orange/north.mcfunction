...
execute if score laser.portal.rotation.ray buffer matches 90..180 run function laser:laser_y/portal_laser_orange/ray/north/left with storage laser:ray
execute if score laser.portal.rotation.ray buffer matches -180..-90 run function laser:laser_y/portal_laser_orange/ray/north/right with storage laser:ray