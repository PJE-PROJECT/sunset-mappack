...
execute if score laser.portal.rotation.ray buffer matches 0..90 run scoreboard players operation laser.portal.rotation.portal buffer -= laser.portal.rotation.ray buffer
execute if score laser.portal.rotation.ray buffer matches 90..180 run scoreboard players operation laser.portal.rotation.portal buffer *= #-1 const
...
execute if score laser.portal.rotation.ray buffer matches 0..90 run function laser:laser_y/portal_laser_orange/ray/south/left with storage laser:ray
execute if score laser.portal.rotation.ray buffer matches 90..180 run function laser:laser_y/portal_laser_orange/ray/south/right with storage laser:ray