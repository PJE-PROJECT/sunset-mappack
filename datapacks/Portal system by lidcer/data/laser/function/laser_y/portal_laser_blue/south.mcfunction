...
execute if score laser.portal.rotation.ray buffer matches -90..0 run function laser:laser_y/portal_laser_blue/ray/south/left with storage laser:ray
execute if score laser.portal.rotation.ray buffer matches 0..90 run function laser:laser_y/portal_laser_blue/ray/south/right with storage laser:ray