...
summon minecraft:creeper ~ ~1000 ~ {Tags:["delta.launcher","delta.init"],Silent:1b,Invulnerable:1b,Team:"delta.no_collide",ExplosionRadius:-1b,Fuse:0s,PersistenceRequired:1b}
