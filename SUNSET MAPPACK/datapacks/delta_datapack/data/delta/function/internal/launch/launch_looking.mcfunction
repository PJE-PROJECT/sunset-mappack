...
execute anchored eyes positioned ^ ^ ^ positioned ~ ~1000 ~ as @e[type=minecraft:creeper,distance=..0.02,tag=delta.init] at @s run function delta:internal/summon/initialize_creepers
