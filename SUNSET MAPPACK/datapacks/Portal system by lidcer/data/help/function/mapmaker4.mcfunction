...
tellraw @s[gamemode=creative] [{"text":"Portalgun Pedestal          : ","color":"gray","type":"text"},{"text":"[Portal 2]","color":"white","clickEvent":{"action":"run_command","value":"/tag @s add pedestalgun_setup"},"hoverEvent":{"action":"show_text","contents":"Portal Gun Pedestal Portal 2"},"type":"text"}]
tellraw @s[gamemode=creative] [{"text":"Portal Gun                     : ","color":"gray","type":"text"},{"text":"[Portal 2]","color":"white","clickEvent":{"action":"run_command","value":"/tag @s add pgun_setup"},"hoverEvent":{"action":"show_text","contents":"Portal Gun from Portal 2"},"type":"text"}]
tellraw @s[gamemode=creative] [{"text":"Vertical Heavy Door         : ","color":"gray","type":"text"},{"text":"[Portal 2]","color":"white","clickEvent":{"action":"run_command","value":"/tag @s add vertdoor_setup"},"hoverEvent":{"action":"show_text","contents":"Vertical Heavy door from Portal 2"},"type":"text"}]
