...
execute positioned ~ ~1 ~ if entity @e[type=minecraft:glow_item_frame,distance=..2.1,tag=indicator,tag=active,limit=1] run function portal:indicators_activate
...
execute positioned ~ ~1 ~ if entity @e[type=minecraft:glow_item_frame,distance=..2.1,tag=indicator,tag=!active,limit=1] run function portal:indicators_disable
