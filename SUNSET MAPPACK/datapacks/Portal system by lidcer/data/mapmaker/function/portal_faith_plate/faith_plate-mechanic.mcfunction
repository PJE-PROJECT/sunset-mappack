...
execute as @e[type=minecraft:item_display,tag=plate_model,tag=plate_anim,scores={animationtime=190..}] run data modify entity @s item.components."minecraft:potion_contents".custom_color set value 838808032
tag @e[type=minecraft:item_display,tag=plate_model,tag=plate_anim,scores={animationtime=190..}] remove plate_anim
