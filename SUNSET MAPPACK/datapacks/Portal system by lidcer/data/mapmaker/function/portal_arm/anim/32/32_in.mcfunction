...
data modify entity @s[tag=empty] item.components."minecraft:custom_model_data" set value 45
data modify entity @s[tag=clean] item.components."minecraft:custom_model_data" set value 47
data modify entity @s[tag=rusted] item.components."minecraft:custom_model_data" set value 49
