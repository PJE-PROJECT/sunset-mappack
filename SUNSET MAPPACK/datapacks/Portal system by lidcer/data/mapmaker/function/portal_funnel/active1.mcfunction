...
execute if block ^ ^ ^1 redstone_block if entity @s[tag=emitter_blue,tag=emitter_orange,tag=active] rotated ~180 ~ align xyz positioned ~0.5 ~-0.5 ~0.5 positioned ^ ^ ^-0.4 run function excursion_funnel:create/orange/horizontal/raycast
