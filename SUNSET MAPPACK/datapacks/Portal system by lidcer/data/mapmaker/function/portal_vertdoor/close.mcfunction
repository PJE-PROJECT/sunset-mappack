...
item replace entity @s[tag=clean] container.0 with minecraft:potion[minecraft:custom_model_data=23,minecraft:potion_contents={custom_color:0}]
item replace entity @s[tag=dirty] container.0 with minecraft:potion[minecraft:custom_model_data=29,minecraft:potion_contents={custom_color:0}]
...
playsound minecraft:awake_chamber_door_open ambient @a ~ ~ ~ 0.5 1 0