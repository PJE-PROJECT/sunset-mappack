...
execute if entity @s[tag=!east,tag=!west] if score @s Distance_funnel_render matches 0..1 if block ^ ^ ^ #excursion_funnel:excursion_funnel_air unless block ^ ^ ^1 #excursion_funnel:excursion_funnel_air unless entity @e[type=minecraft:item_display,distance=..0.1,tag=funnel,limit=1,y_rotation=0] unless entity @e[type=minecraft:item_display,distance=..0.1,tag=funnel,limit=1,y_rotation=180] run summon minecraft:item_display ~ ~ ~ {Tags:["funnel","funnel_o","funnel_new","funnel_h"],item_display:"fixed",brightness:{sky:15,block:15},width:2,height:2}
...
execute positioned ^ ^0.5 ^0.5 if entity @e[type=minecraft:armor_stand,distance=..0.5,tag=sbpg.portal,tag=!floor,tag=!ceiling,tag=!45_portal] run function excursion_funnel:create/orange/horizontal/portals



# Зацикливание функции
execute if block ^ ^ ^1 #excursion_funnel:excursion_funnel_air if block ^ ^1 ^ #excursion_funnel:excursion_funnel_air if entity @s[scores={Distance_funnel=..100}] positioned ~ ~-1 ~ unless entity @e[distance=..1,tag=excursion_funnel_stop] positioned ~ ~1 ~ positioned ^ ^ ^1 run function excursion_funnel:create/orange/horizontal/raycast_loop
