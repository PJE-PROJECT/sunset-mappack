...
execute at @e[type=minecraft:area_effect_cloud,tag=sbpg.portal_first,tag=sbpg.portal_main,tag=floor,tag=east,limit=1] run tp @s[tag=bghost] ^ ^0.73 ^1.4 ~ ~180
execute at @e[type=minecraft:area_effect_cloud,tag=sbpg.portal_first,tag=sbpg.portal_main,tag=floor,tag=south,limit=1] run tp @s[tag=bghost] ^-0.1 ^0.73 ^1.4 ~ ~180
...
execute at @e[type=minecraft:area_effect_cloud,tag=sbpg.portal_second,tag=sbpg.portal_main,tag=floor,tag=east,limit=1] run tp @s[tag=oghost] ^ ^0.73 ^1.4 ~ ~180
execute at @e[type=minecraft:area_effect_cloud,tag=sbpg.portal_second,tag=sbpg.portal_main,tag=floor,tag=south,limit=1] run tp @s[tag=oghost] ^-0.1 ^0.73 ^1.4 ~ ~180
