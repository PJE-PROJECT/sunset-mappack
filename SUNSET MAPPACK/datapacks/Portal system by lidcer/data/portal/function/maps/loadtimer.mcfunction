#execute if entity @e[type=item_display,tag=playerstart,limit=1] if entity @e[type=minecraft:item_display,tag=elevator_main_pos,tag=departure,limit=1] run function portal:maps/updatemap
...
#execute if entity @e[type=item_display,tag=playerstart,limit=1] if entity @e[type=minecraft:interaction,tag=trigger_nextmap,limit=1] run function portal:maps/updatemap
