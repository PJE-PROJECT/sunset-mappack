# Highprec: Intended for |x| <= 1 (e.g: look vector)
...
scoreboard players operation x workspace /= 16384 constant
scoreboard players operation y workspace /= 16384 constant
scoreboard players operation z workspace /= 16384 constant
