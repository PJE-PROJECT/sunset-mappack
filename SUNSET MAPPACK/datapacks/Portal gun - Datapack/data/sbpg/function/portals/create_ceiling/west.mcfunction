# Summon all entities
summon minecraft:armor_stand ~ ~ ~ {Invisible:1b,Tags:["sbpg.portal","sbpg.portal_edge","sbpg.portal_new","ceiling","west"],Pose:{Head:[90.0f,-90.0f,0.0f]},ArmorItems:[{},{},{},{id:"minecraft:leather_boots",components:{"minecraft:damage":6,"minecraft:dyed_color":{rgb:39423},"minecraft:unbreakable":{}},count:1}],NoGravity:1b,Invulnerable:1b,Fire:32767s,Marker:1b}
