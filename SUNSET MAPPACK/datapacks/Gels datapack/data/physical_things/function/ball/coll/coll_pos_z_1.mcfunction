...
execute if score *air main_score matches 1 run scoreboard players add *coll_z_all main_score 1
execute if score *air main_score matches 0 if score *air2 main_score matches 0 run scoreboard players remove *vector_z main_score 2
...
execute if score *air main_score matches -1 run scoreboard players remove *vector2_z main_score 1
